  ...
  <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
    ...
    <div>
      ...
      <div className="flex items-center mt-1 space-x-3">
        <Link href="https://discord.gg/68JWBSpJKD" title="Discord" target="_blank" className="text-gray-500 transition-colors duration-300 hover:text-yellow-500">
        ...
        <Link target="_blank" title="Instagram" href="https://www.instagram.com/goldskill_tradegroup?igsh=MWpyOGZ6eGtobHNhcw%3D%3D&utm_source=qr" className="text-gray-500 transition-colors duration-300 hover:text-yellow-500">
