  ...
  <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
    <div className="sm:col-span-2">
      <a href="#start" aria-label="Go home" title="Company" className="inline-flex items-center">
        <Image className="w-12 h-12 mr-4" src="/LogoBiel.JPG" alt="Logo Goldskill"/>
    ...
    <div>
      ...
      <div className="flex items-center mt-1 space-x-3">
        <Link href="/" className="text-gray-500 transition-colors duration-300 hover:text-yellow-500">
