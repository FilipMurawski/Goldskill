...
import { Forgot_password_Form } from "@/components/forgot-password-form";
...
const  Page = () => {
    ...
    <div className="min-h-screen bg-gray-100 text-gray-900 flex justify-center">
        ...
        <h1 className="text-2xl font-bold text-center mb-6"> Zapomniałeś hasło? </h1>
        <h3 className="text-xl text-center mb-6">Podaj swój email aby zresetować hasło.</h3>
