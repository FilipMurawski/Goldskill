    ...
    <Section id="dlaczego" wrap="no-wrap">
      ...
      <div className="w-[50%] min-w-52 flex justify-center items-center space-y-10 flex-col">
        ...
        <div className="flex justify-center items-start space-x-[10%] space-y-[10%] w-[100%] text-gray-600 flex-col sm:flex-row sm:space-y-0 ">
          <div className="flex justify-center flex-col items-center min-w-[calc(84%/3)] gap-4"><img src="/Book.png" className="w-16 h-16 grayscale-0"/> <p>Skupiamy się na dostarczaniu solidnych fundamentów i umiejętności, które pozwolą Ci zrozumieć rynki finansowe oraz podejmować świadome decyzje inwestycyjne.</p></div>
          <div className="flex justify-center flex-col items-center min-w-[calc(84%/3)] gap-4"><img src="/Chart.png" className="h-16 w-16 grayscale-0 scale-110 translate-y-1"/> <p>GoldSkill to społeczność, która pomaga na każdym poziomie zaawansowania. Nasi eksperci są dostępni, by odpowiadać na pytania i rozwiązywać problemy.</p></div>
          <div className="flex justify-center flex-col items-center min-w-[calc(84%/3)] gap-4"><img src="/Magnifying Glass.png" className="w-16 h-16 grayscale-0"/> <p> Dzięki dostępowi do zamkniętej grupy zawsze otrzymasz niezbędną pomoc. Dodatkowo oferujemy kompleksowe kursy, codzienne analizy i wsparcie w realnym czasie.</p></div>
        </div>
      </div>
    </Section>
